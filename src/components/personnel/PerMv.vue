...
//        console.log(data,checked,indeterminate)
    ...
    data(){
      return {
        ...
        //children的假数据
        children:[
            {children:null,component:null,iconCls:null,id:11,meta:null,name:"角色管理",path:null},
            {children:null,component:null,iconCls:null,id:11,meta:null,name:"下载管理",path:null},
            {children:null,component:null,iconCls:null,id:11,meta:null,name:"配置管理",path:null},
            {children:null,component:null,iconCls:null,id:11,meta:null,name:"可视化编辑",path:null},
        ],
        component:null,
        iconCls:null,
        id:1,
